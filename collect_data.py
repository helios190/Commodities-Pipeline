from scrapping.jfx_scrapping import scrape_table_data
from scrapping.BI_scrapping import download_inflation_data
from scrapping.BPS_scrapping import fetch_and_transform_bps_data
